...
export const invokeFunction = form('unchecked', async (data: { args?: string }) => {
  ...
  const resp = await fetch(`${apiBase}/auth/functions/${functionId}/invoke`, {
    method: 'POST',
    headers: {
